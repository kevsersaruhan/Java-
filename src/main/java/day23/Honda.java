...
public abstract class Honda {
    /*
        ...
        8) If you want to make a functionality for all "concrete child classes" make the method "abstract" in parent class
        9)Can we make an abstract class final class?
        "final classes" cannot have child classes, we create "abstract classes" to do sth mandatory for child classes. This is contradiction
        because of that Java does not allow to make an abstract class "final"
        10)"abstract methods" were created to override, if you make an abstract method "private" it cannot be overridden, therefore Java does not allow
        to make an abstract method "private"
        11)We cannot create objects from "abstract classes" because "abstract classes" have sth un-complete like "abstract methods"
           Note: "abstract classes" are, therefore they have "constructors, but the constructors cannot create objects.
        12)If any abstract method was overridden by any "concrete class"(A),
           it is not mandatory to override the abstract method for the concrete child classes of the "concrete class (A)
     */
    public abstract void  engine();

    public void mucSystem(){
