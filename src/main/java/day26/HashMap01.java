...
public class HashMap01 {
    /*
        ...
        5)You can use a multiple "null" in values part
    ...
    public static void main(String[] args) {
        ...
        for(String w : keys){
            totalNumOfLetters +=w.replaceAll("[^a-zA-Z]","").length();
        }

        System.out.println(totalNumOfLetters);//48
        ...
        System.out.println(hMap.containsKey("Angelina Jolie"));//true
        System.out.println(hMap.containsValue(85));//true

        //replace after checking key and value
        System.out.println(hMap.replace("Cuneyt Arkin",85,63));//true

        //replace after checking just key
        hMap.replace("Brad Pitt",5);
        System.out.println(hMap);
    }
}
