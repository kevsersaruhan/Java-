...
public class TreeSet01 {
    /*
         1)TreeSet if for storing "unique elements" in "natural order"
         2)TreeSet is very slow because of that we don't want to do adding, and removing operations with TreeSet
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        tSet.add("Apricot");
        tSet.add("Palm");
        //tSet.add(null); ==> TreeSet does not allow to add "null" as element

        System.out.println(tSet);//[Apple, Apricot, Mango, Orange, Palm]

        SortedSet<String> sub1 =  tSet.subSet("Apricot","Orange"); //First is inclusive second is exclusive
        ...
        //ceiling() returns the next element after the given element if the element does not exist
        ...
        //floor() returns the next element before the given element if the element does not exist
        String el4= tSet.floor("Nancy");
        System.out.println(el4);//Mango


        //floor() returns the given element the given element exist
        ...
        //[Apple, Apricot, Mango, Orange, Palm]
        //tailSet() returns the elements from the end to the given element(insclusive)
